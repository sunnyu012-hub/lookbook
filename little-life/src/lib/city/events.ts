...
export const CITY_EVENTS: CityEventDef[] = [
  {
    ...
    effectLabel: 'MIND EXP +10%',
    rarity: 'COMMON',
  },
  {
    id: 'tiny_flea_market',
    name: 'Tiny Flea Market',
  ...
  },
  {
    ...
    effectLabel: 'BODY · HEART EXP +10%',
    rarity: 'COMMON',
  },
  {
    id: 'late_night_star',
    name: 'Late Night Star',
    description: '오늘 밤엔 뭔가 떨어질 것 같다.',
    icon: '💫',
    areaId: 'NIGHT_TOWN',
    bonuses: { rareDropChancePct: 5, luck: 1 },
    effectLabel: 'Rare 이상 드롭 +5%',
    rarity: 'EPIC',
    band: 'NIGHT',
  },
  {

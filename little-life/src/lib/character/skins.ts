...
const PACK_ROWS: Record<SkinPackId, readonly PackRow[]> = {
  ...
  7: [
    ['hoodie_and_jeans', '후드티와 청바지', '고민하기 싫은 날의 정답.'],
    ['white_tee_slacks', '흰 티에 검정 슬랙스', '어디에 가도 안 튄다.'],
    ['knit_cardigan_cotton_pants', '니트 가디건과 면바지', '벗었다 입었다 하기 좋다.'],
    ['shirt_dress_day', '셔츠 원피스 하나', '하나만 입으면 끝나는 날.'],
    ['sweatshirt_jogger', '맨투맨과 조거팬츠', '집이랑 밖의 중간쯤.'],
    ['denim_jacket_long_skirt', '데님 재킷과 롱스커트', '위아래 무게가 잘 맞는다.'],
    ['thin_knit_wide_pants', '얇은 니트와 와이드팬츠', '편한데 대충 입은 것 같진 않다.'],
    ['check_shirt_layer', '체크 셔츠 하나 걸치고', '단추는 안 잠근다.'],
    ['tee_and_shorts', '반팔에 반바지', '더 줄일 게 없는 차림.'],
    ['hood_zipup_leggings', '후드집업과 레깅스', '잠깐 움직이러 나갈 때.'],
    ['blouse_slim_jeans', '블라우스와 슬림 진', '위만 차려입으면 되는 자리.'],
    ['sweater_corduroy', '스웨터와 코듀로이', '가을 냄새가 나는 조합.'],
  ],
  8: [

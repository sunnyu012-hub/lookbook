...
const SEEDS: Record<Daypart | 'any', QuestDraft[]> = {
  morning: [
    ...
    { title: '오늘 할 일 세 가지 정하기', category: 'WORK', difficulty: 'NORMAL' },
    { title: '아침 챙겨 먹기', category: 'BODY', difficulty: 'NORMAL' },
    { title: '제일 미룬 일 시작하기', category: 'WORK', difficulty: 'HARD' },
  ],
  afternoon: [
    { title: '가장 중요한 일 25분 하기', category: 'WORK', difficulty: 'NORMAL' },
    { title: '잠깐 산책하기', category: 'BODY', difficulty: 'EASY' },
    { title: '책상 정리하기', category: 'LIFE', difficulty: 'NORMAL' },
    { title: '밀린 이메일 답장하기', category: 'WORK', difficulty: 'NORMAL' },
    { title: '미뤄둔 예약하기', category: 'LIFE', difficulty: 'HARD' },
  ],
  evening: [
    { title: '설거지 끝내기', category: 'LIFE', difficulty: 'NORMAL' },
    { title: '책 10쪽 읽기', category: 'MIND', difficulty: 'EASY' },
    { title: '10분 스트레칭', category: 'BODY', difficulty: 'NORMAL' },
    { title: '빨래 개서 넣기', category: 'LIFE', difficulty: 'NORMAL' },
    { title: '내일 필요한 것 준비하기', category: 'LIFE', difficulty: 'NORMAL' },
  ],
  any: [
    { title: '부모님께 안부 연락하기', category: 'HEART', difficulty: 'NORMAL' },
    { title: '감사한 일 3개 적기', category: 'MIND', difficulty: 'NORMAL' },
    { title: '짧은 일기 쓰기', category: 'MIND', difficulty: 'NORMAL' },
    { title: '10분 명상하기', category: 'MIND', difficulty: 'NORMAL' },
    { title: '좋아하는 노래 한 곡 듣기', category: 'PLAY', difficulty: 'EASY' },
    { title: '미뤄둔 작은 일 하나 끝내기', category: 'LIFE', difficulty: 'NORMAL' },
    { title: '미뤄둔 서류 처리하기', category: 'LIFE', difficulty: 'HARD' },
  ],
}

...
export const ITEMS: ItemDef[] = [
  ...
  // 마시는 것 — 다음 퀘스트 한 번에만 걸린다
  {
    ...
    icon: '☕',
    equipSlot: null,
    effectLabel: '다음 WORK 퀘스트 EXP +20%',
    bonuses: {},
  ...
  },
  {
    ...
    icon: '🍵',
    equipSlot: null,
    effectLabel: '다음 MIND 퀘스트 EXP +20%',
    bonuses: {},
  ...
  {
    id: 'morning_sneakers',
    name: 'Morning Sneakers',
    description: 'Haru 가 신어보라며 준 운동화. 발이 가볍다.',
    type: 'EQUIPMENT',
    rarity: 'RARE',
    icon: '👟',
    equipSlot: 'SHOES',
    effectLabel: 'BODY EXP +6%',
  ...
  },
  {
    ...
    icon: '🍀',
    equipSlot: 'CHARM',
    effectLabel: 'Luck +2 · HEART EXP +4%',

...
export interface User {
   ...
   * 가게에서 한 번이라도 본 모습들.
   *
   * 도감이 실루엣 대신 진짜 그림을 보여줄지 정한다. 안 산 옷이어도
   * 가게에서 봤으면 "그 옷" 으로 남아야 한다 — 봤는데 다음 날 다시
   * 실루엣이 되면 도감이 기억을 못 하는 셈이다.
   *
   * 가진 것과 따로 둔다. 산 순간 ownedSkinIds 로 가는 게 아니라 둘 다 참이 된다 —
   * 되돌릴 일이 생겨도 "본 적 있다" 는 사실은 안 사라진다.
   */
  seenSkinIds: SkinId[]
  /**

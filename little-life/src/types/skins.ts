...
export const SKIN_IDS = [
  ...
  'little_life_lead',
  // 7팩 — 오늘 진짜 입고 나간 옷
  'oatmeal_sweatshirt_daily',
  'coral_tee_light_denim',
  'sage_check_shirt_layered',
  'charcoal_cardigan_raw_denim',
  'dusty_blue_work_jacket',
  'cream_knit_vest_long_skirt',
  'dusty_red_rugby_shirt',
  'shirring_blouse_cargo_skirt',
  'denim_shirt_setup',
  'lavender_shirt_dress',
  'city_windbreaker_wide_pants',

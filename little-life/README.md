...
- 도감 240개 중 **211개**에 진짜 그림이 있다 (트로피 6개 · 재료 8개 포함해 파일 225장)
- 19개는 아직 이모지로 그린다
- 그림도 이모지도 없는 **10개**(원목 벤치·빈백·미니 식탁, 러그 4종, 담요 2종, 노란 쿠션)만 실루엣이고, 방에는 아직 못 놓는다
...
도감 그림 225장(3.7MB)은 **첫 실행에 한꺼번에 받지 않는다.**

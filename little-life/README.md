...
- 도감 240개 중 **185개**에 진짜 그림이 있다 (트로피 6개 · 재료 8개 포함해 파일 199장)
- 44개는 아직 이모지로 그린다
- 그림도 이모지도 없는 **11개**(벤치·빈백·식탁 3, 러그 4, 담요·쿠션 3, 빗 1)만 실루엣이고, 방에는 아직 못 놓는다
...
도감 그림 199장(3.2MB)은 **첫 실행에 한꺼번에 받지 않는다.**
